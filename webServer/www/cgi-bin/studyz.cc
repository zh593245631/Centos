    ...
    //cout<<"success"<<endl;
         ...
         body = "<body background=\"http://212.129.243.64/bj.png\"\r\n\
                ...
                body = "<body background=\"http://212.129.243.64/bj.png\"\
                        ...
                        <h3>学习视频</h3>\
                        <form name = \"input1\"\
                        action = \"/cgi-bin/bulletinz.cgi\" method = \"post\" id = \"form5\">\
                        <input type=\"text\" style=\"display:none;\" value=\""+rett+"\" name = \"ret\">\
                        <input type=\"text\" style=\"display:none;\" value=\"cgi1\" name = \"gg\">\
...
<form name = \"input1\"\
                        action = \"/cgi-bin/bulletinz.cgi\" method = \"post\" id = \"form6\">\
                        <input type=\"text\" style=\"display:none;\" value=\""+rett+"\" name = \"ret\">\
                        <input type=\"text\" style=\"display:none;\" value=\"cgi1\" name = \"gg\">\
                        <div style=\"padding-left:20px; padding-top:0px\">\
                        cgi技术--------------------2019-7-2\
...
<form name = \"input1\"\
                        action = \"/cgi-bin/bulletinz.cgi\" method = \"post\" id = \"form7\">\
                        <input type=\"text\" style=\"display:none;\" value=\""+rett+"\" name = \"ret\">\
                        <input type=\"text\" style=\"display:none;\" value=\"scg1\" name = \"gg\">\
                        <div style=\"padding-left:20px; padding-top:0px\">\
                        scg技术--------------------2019-7-2\
                        <input type = \"submit\" value= \"查看\" style='font-size:10px'>\
                        </div>\
...
<form name = \"input1\"\
                        action = \"/cgi-bin/bulletinz.cgi\" method = \"post\" id = \"form8\">\
                        <input type=\"text\" style=\"display:none;\" value=\""+rett+"\" name = \"ret\">\
                        <input type=\"text\" style=\"display:none;\" value=\"scg1\" name = \"gg\">\
                        <div style=\"padding-left:20px; padding-top:0px\">\
                        scg技术--------------------2019-7-2\
